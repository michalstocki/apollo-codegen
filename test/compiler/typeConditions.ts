...
import { mergeInFragmentSpreads } from '../../src/compiler/mergeInFragmentSpreads';
...
describe('TypeCase', () => {
  ...
  it('should recursively include fragment spreads with type conditions that match the parent type', () => {
    ...
    const heroField = context.operations['Hero'].selectionSet.selections[0] as Field;
    const typeCase = new TypeCase(mergeInFragmentSpreads(context, heroField.selectionSet));
